...
import cn.codehero.ioc.context.object.BeanCreatorObject1;
import cn.codehero.ioc.context.object.BeanCreatorObject2;
import cn.codehero.ioc.context.object.interfaces.Implement;
import cn.codehero.ioc.context.object.interfaces.TestImplement;
...
public class BeanCreatorTest extends TestCase {
	...
	public void testCreateBeanUseDefaultConstruct() {
		//无参数构造器创建实例
		String className = "cn.codehero.ioc.context.object.BeanCreatorObject1";
	...
	public void testCreateBeanUseDefineConstruce() {
		//有参数构造器创建实例
		String className = "cn.codehero.ioc.context.object.BeanCreatorObject2";
